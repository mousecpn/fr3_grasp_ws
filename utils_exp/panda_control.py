...
class PandaCommander(object):
    ...
    def home(self, velocity_scaling=0.2, acceleration_scaling=0.2):
        self.goto_joints([0, -0.785, 0, -2.356, 0, 1.57, 0.785], velocity_scaling=velocity_scaling, acceleration_scaling=acceleration_scaling)
    ...
    def check_pose_achievable(self,pose,velocity_scaling=0.1, acceleration_scaling=0.1):
        pose_msg = ros_utils.to_pose_msg(pose)
        self.move_group.set_max_velocity_scaling_factor(velocity_scaling)
        self.move_group.set_max_acceleration_scaling_factor(acceleration_scaling)
        self.move_group.set_pose_target(pose_msg)

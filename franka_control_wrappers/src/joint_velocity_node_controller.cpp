...
namespace franka_control_wrappers {
    ...
    public:
        bool init(hardware_interface::RobotHW* robot_hardware, ros::NodeHandle& node_handle) {
            ...
            vel_cmd_sub = node_handle.subscribe("/joint_velocity_node_controller/joint_velocity", 1, &JointVelocityNodeController::cmd_callback, this);
...
PLUGINLIB_EXPORT_CLASS(franka_control_wrappers::JointVelocityNodeController,
